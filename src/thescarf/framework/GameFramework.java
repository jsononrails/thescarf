...
import thescarf.framework.utility.*;
...
public abstract class GameFramework extends JFrame implements Runnable {
	...
	protected Matrix3x3f getViewportTransform() {
		...
		return GraphicsUtils.createViewport(appWorldWidth, appWorldHeight, 
	...
	protected Matrix3x3f getReverseViewportTransform() {
		...
		return GraphicsUtils.createReversViewport(appWorldWidth, appWorldHeight, getScreenWidth(), getScreenHeight());
