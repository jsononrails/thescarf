...
public class PrototypeGame extends GameBase {
	...
	// this creates teh random stars for the background
	...
	private void createAsteroids() {
		...
		for(int i = 0; i < 4; ++i) {
			...
			asteroids.add(factory.createAsteroid(position,SizeEnum.Large));
	...
	private void spawnBabies(PrototypeAsteroid asteroid) {
		...
		if(asteroid.getSize() == SizeEnum.Large) {
			
			asteroids.add(factory.createAsteroid(asteroid.getPosition(), SizeEnum.Medium));
			asteroids.add(factory.createAsteroid(asteroid.getPosition(), SizeEnum.Medium));
			
		}
		
		if(asteroid.getSize() == SizeEnum.Medium) {
			
			asteroids.add(factory.createAsteroid(asteroid.getPosition(), SizeEnum.Small));
			asteroids.add(factory.createAsteroid(asteroid.getPosition(), SizeEnum.Small));
